...
# Profile-on-stall rescue toggle (A/B test). TRUE (default) runs the 1-D
# frozen-base profile warm-start when a candidate stalls; FALSE disables it so
# the power contribution of that rescue can be isolated. Changing this alters
